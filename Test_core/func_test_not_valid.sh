...
./vm $FLAGS ./champs_for_for_etalon/$CHAMP > 2.txt
...
./vm $FLAGS ./champs_for_for_etalon/$CHAMP1 ./champs_for_for_etalon/$CHAMP2 > 2.txt
echo Diff 2 1
diff -u 1.txt 2.txt
echo Diff 2 1 end
...
./vm $FLAGS ./champs_for_for_etalon/$CHAMP1 ./champs_for_for_etalon/$CHAMP2 ./champs_for_for_etalon/$CHAMP3 > 2.txt
echo Diff 3 1
diff -u 1.txt 2.txt
echo Diff 3 1 end
